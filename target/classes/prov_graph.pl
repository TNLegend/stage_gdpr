...
purposes('consent_David_1','phoneNumber_David_1_purposes',['sendAdSMS']).
purposes('consent_David_1','consent_type',purposes_consent).
purposes('consent_David_1','id_David_1_purposes',['sendImprovementCookie','sendThirdPartiesCookie']).
purposes(_,'name_David_1_purposes',['buyItem']).
purposes(_,'physicalAddress_David_1_purposes',['buyItem']).
purposes(_,'mail_David_1_purposes',['sendMail','sendTicket']).
purposes(_,'__purposes',['consent','delete','askErase','sendData','askDataAccess','updateConsent','updateData','createAccount']).
purposes(_,'bankAccount_David_1_purposes',['buyItem','askRefund','refund']).
